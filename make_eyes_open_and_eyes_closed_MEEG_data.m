...
fold = dir(fullfile(['/home/frederik/data/EEG_rest/prep_cleaned/*R01*cleaned*.set']))
files for EC data
fold2 = dir(fullfile(['/home/frederik/data/EEG_rest/prep_cleaned/*R02*cleaned*.set']))
...
EEG = pop_loadset('filename',fold(i).name,'filepath','/home/frederik/data/EEG_rest/prep_cleaned/');
%%% load pre-processed EEGLAB data EC
EEG2 = pop_loadset('filename',fold2(i).name,'filepath','/home/frederik/data/EEG_rest/prep_cleaned/');
[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );

%% load template MEEG object (made available at github)
D = spm_eeg_load('/home/frederik/data/EEG_rest/spm_files/test5');
%% make new MEEG object 
 D = clone(D,['/home/frederik/data/EEG_rest/spm_data/spm_meeg_' fold(i).name(1:4) '_EO_EC'],[64 size(EEG.data(:,end-1600:end),2) 2],0)
