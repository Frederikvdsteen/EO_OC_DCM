...
%make main window
main_fig=figure('Units','normalized','Visible','off','Position',[0.1,0.1,0.3,0.5],'Color',[0.5 0.5 0.5],'name','permutation_based ttest on matrices','Menubar','none','NumberTitle','off');
method = mute_config();
